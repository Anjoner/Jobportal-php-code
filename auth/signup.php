...
<html class="no-js" lang="zxx">
        ...
        <div class="bg-img">
            <div class="content">
              ...
              <form id="signupForm">
                ...
                <div class="field space">
                  <span class="fa fa-lock"></span>
                  <input type="password" name = "confirm_password" class="pass-key2" required placeholder="confirm Password">
                  <span class="show">SHOW</span>
                </div> <br>
                <div id="error" class="strength"></div> <br>
  ...
  <!-- JS here -->
        ...
        <script>
            ...
            const showBtn2 = document.querySelector('.show');
        ...
        <script>
          ...
          const strengthMsg = document.getElementById('error');
          ...
          passwordInput.addEventListener('input', function () {
            ...
            if (strong.test(pass)) {
              ...
              strengthMsg.textContent = 'Medium Password (not allowed)';
              strengthMsg.className = 'strength medium';
              currentStrength = 'medium';
            } else {
              strengthMsg.textContent = 'Weak Password (not allowed)';
            ...
            document.getElementById("signupForm").addEventListener("submit", function(e) {
                ...
                // Prevent submit if not strong
                if (currentStrength !== 'strong') {
                  document.getElementById('error').innerText = 'Password must be strong to register.';
                  return;
                }
