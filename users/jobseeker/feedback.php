    ...
    <main>
        <div class="container m-auto align-items-center">
            <div class="row">
                ...
                <div class="col-sm-10 col-md-6 col-lg-6 col-xl-6 offset-3">
                    ...
                    <form id="feedbackForm" >
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <textarea name="message" rows="5" cols="50" placeholder="Enter your feedback"  class="form-control" id ="message" required></textarea>
                        </div>
