...
if (isset($_GET['delete'])) {
  $id = $_GET['delete'];
    ...
    if (!mysqli_query($conn, $query)) {
        $error = "Cannot delete this Category, to delete this first delete jobs that associated with it";
                ...
                <div class="col-sm-10 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" name="name" placeholder="Category Name" value="<?= $edit_category['name'] ?? '' ?>" class="form-control" id="name" required >
                        ...
                        <div class="">
                            <button type="submit" name="<?= $edit_category ? 'update' : 'add' ?>" class="btn btn-primary btn-lg">
                            <?= $edit_category ? 'Update' : 'Add' ?>
                            </button> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="?delete=<?= $row['id'] ?>" onclick="return confirm('Delete this category?')"  class="btn btn-danger btn-lg">Delete</a>
                              </td>
                            </tr>
                          <?php endwhile; ?>
                        </table> <br>
