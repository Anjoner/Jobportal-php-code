...
if (isset($_GET['delete'])) {
    ...
    if (!mysqli_query($conn, $query)) {
        $error = "Cannot delete this location, to delete this first delete jobs that associated with it";
...
if (isset($_GET['edit'])) {
  $id = $_GET['edit'];
  $edit_location = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM locations WHERE id = $id"));
}
            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-6 col-lg-6 col-xl-6"> <br>
                    ...
                    <div class="form-head">
                        ...
                        <h2><?= $edit_location ? 'Edit' : 'Add' ?> Location</h2>
                    </div>    
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="text" name="name" placeholder="location Name" value="<?= $edit_location['name'] ?? '' ?>" class="form-control" id="name" required >
                        ...
                        <div class="">
                            <button type="submit" name="<?= $edit_location ? 'update' : 'add' ?>" class="btn btn-primary btn-lg">
                            <?= $edit_location ? 'Update' : 'Add' ?>
                            </button> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                ...
                                <a href="?delete=<?= $row['id'] ?>" onclick="return confirm('Delete this location?')"  class="btn btn-danger btn-lg">Delete</a>
                              </td>
                            </tr>
                          <?php endwhile; ?>
                        </table> <br>
