                ...
                <div class="col-sm-10 col-md-6 col-lg-6 col-xl-6">
                    ...
                    <form id="signupForm">
                        ...
                        <div class="mb-3 mt-3">
                            ...
                            <input type="password" class="form-control" id="password1" name="password" required class="pass-key" >
                        </div>
                        <div class="mb-3 mt-3">
                            <label for="password2" class="form-label">confirm password:</label>
                            <input type="password" class="form-control" id="password2" name="confirm_password" required class="pass-key" >
                        </div>
                        ...
                        <a href="useraccount.php" class="btn btn-danger btn-lg">Cancel</a>
            ...
            document.getElementById("signupForm").addEventListener("submit", function(e) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        localStorage.setItem('usercreationSuccess', data.message);
